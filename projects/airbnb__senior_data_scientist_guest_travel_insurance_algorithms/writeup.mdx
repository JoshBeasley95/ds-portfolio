...
![Calibration curve and threshold sweep](./charts/05_calibration_threshold.png)
...
![Decile lift chart](./charts/10_decile_lift.png)
...
![SHAP summary beeswarm](./charts/07_shap_summary.png)
...
![Per-guest SHAP waterfall](./charts/09_shap_waterfall.png)
